...
public:
    ...
    */
    ...
    NetworkController& operator=(
        const NetworkController&) = delete;
    ...
    *         in the region.
    */
    bool addTrainNetwork(const QString& name,
    ...
    *         if not found.
    */
    NeTrainSimNetworkBase* trainNetwork(
        const QString& name,
    ...
    */
    IntegrationNetworkBase* truckNetwork(
        const QString& name,
        const QString& region) const;
...
signals:
    ...
    * @param region Region of the network.
    */
    void truckNetworkConfigRemoved(
        const QString& name,
        const QString& region);
...
private:
    ...
    */
    QMap<QString, QMap<QString, NeTrainSimNetworkBase*>>
        m_trainNetworks;
