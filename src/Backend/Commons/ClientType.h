/**
* @file ClientType.h
* @brief Defines the ClientType enumeration class for CargoNetSim's
...
/**
* @class ClientType
* @brief Strongly-typed enumeration class representing different types
*        of clients in the cargo network.
*
* ClientType wraps an enumeration that identifies various transport clients
* within the CargoNetSim system.
* It is implemented as a Q_GADGET to allow for Qt meta-type system integration,
* enabling use in QML, signal-slot connections, and property systems.
*/
class ClientType {
    Q_GADGET
public:
    /**
    * @enum Value
    * @brief Enumeration of available client types in the cargo network system.
    */
    enum Value {
    ...
    * @param value The ClientType::Value to initialize with.
    */
    ...
    */
    ...
    /**
    * @brief Converts the client type to a human-readable string.
...
* @return True if the client types are the same, false otherwise.
*/
inline bool operator==(ClientType lhs, ClientType rhs) {
    return lhs.operator ClientType::Value() == rhs.operator ClientType::Value();
}
...
* @param lhs Left-hand side operand.
* @param rhs Right-hand side operand.
* @return True if the client types are different, false otherwise.
*/
inline bool operator!=(ClientType lhs, ClientType rhs) {
    return !(lhs == rhs);
}
...
// Register the ClientType class with Qt's meta-object system
