 ...
 * application
 *
 * This class provides centralized error handling
...
public:
    /**
     * @brief Install all exception handlers for the
     * application
     *
    ...
    /**
     * @brief Handler for Qt's debug/warning/critical/fatal
     * messages
     *
     * @param type Message type (debug, warning, critical,
     * fatal)
     * @param context Message context
     * @param message The actual message text
     */
    static void
    qtMessageHandler(QtMsgType                 type,
...
private:
    ...
    ErrorHandlers &
    operator=(const ErrorHandlers &)           = delete;
...
public:
    ...
    /**
     * @brief Override this method to implement thread-safe
     * work
     */
    virtual void runSafe() = 0;
};

// Global function for installing exception handlers (for
// convenience)
