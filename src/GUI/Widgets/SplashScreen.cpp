      ...
      m_isFinished(false)
{
    ...
    if (m_originalPixmap.isNull()) {
        ...
        painter.drawText(m_originalPixmap.rect(), Qt::AlignCenter, "CargoNetSim");
    }
...
void SplashScreen::updateLayout() {
    ...
    m_progressBar->setGeometry(
        (width - barWidth) / 2,
        height - barHeight - 40,  // 40px from bottom
        barWidth,
        barHeight
    );
    
    // Set status label position and size (above progress bar)
