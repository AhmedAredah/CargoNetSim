 ...
 *
 * This class extends QSplashScreen to add a progress bar
...
class SplashScreen : public QSplashScreen
{
    ...
    Q_PROPERTY(
        QString statusMessage READ statusMessage WRITE
            setStatusMessage NOTIFY statusMessageChanged)

public:
    /**
     * @brief Default constructor
     *
     * Creates a splash screen with the application logo and
     * a progress bar
     */
    SplashScreen();
...
public slots:
     ...
     *
     * Overrides QSplashScreen::showMessage to update
     * internal status
     *
...
private:
    ...
    bool    m_isFinished; ///< Flag indicating if splash is
                          ///< finished
};
