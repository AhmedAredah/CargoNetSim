    ...
    : QMainWindow(parent)
{
    ...
    // Create center widget that will fill the space between docks
...
void CustomMainWindow::addDockWidget(Qt::DockWidgetArea area, QDockWidget* dockWidget)
{
    // Check if this is a special case dock that should go in the center splitter
    if (dockWidget && dockWidget->objectName() == "ShortestPathTableDock") {
