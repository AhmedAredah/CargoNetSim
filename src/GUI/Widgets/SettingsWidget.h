...
/**
 * @brief Settings widget for configuring simulation parameters.
 * 
 * This widget provides a graphical interface for configuration of all simulation parameters
 * including fuel types, carbon emissions, and transportation mode settings.
 */
...
public:
     ...
     * @return QMap<QString, QVariant> The current settings values
     */
...
private slots:
    /**
     * @brief Updates the fuel type table with current values
     */
     ...
     */
    void updateFuelData(const QString& fuelType, const QString& key, const QVariant& value);
     ...
     * @param dwellGroup The group box containing dwell time settings
     */
...
private:
     ...
     */
    void addNestedPropertiesSection(const QMap<QString, QVariant>& item, 
     ...
     */
    QPair<QFormLayout*, QMap<QString, QWidget*>> createDwellTimeParameters(
        const QString& method, 
        const QMap<QString, QVariant>& currentParams = QMap<QString, QVariant>());
