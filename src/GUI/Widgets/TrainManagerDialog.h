 ...
 * 
 * The TrainManagerDialog allows users to load, view, and manage train 
 * configurations used in simulations. It handles importing train
 * data from files and maintaining a list of available trains.
 */
...
signals:
    /**
     * @brief Signal emitted when trains are loaded from a file
...
private:
     ...
     */
    QString formatTrainDetails(const Backend::Train* train) const;
