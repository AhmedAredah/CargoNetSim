...
/**
 * @brief The ShapeIcon class draws different geometric shapes that can be used
 * as visual indicators in the UI.
 * 
 * Supports various shapes like circle, rectangle, triangle, diamond.
 */
class ShapeIcon : public QWidget {
    Q_OBJECT
    Q_PROPERTY(QString shapeType READ shapeType WRITE setShapeType NOTIFY shapeTypeChanged)
...
public:
    /**
     * @brief Constructs a ShapeIcon with the specified shape type
     * @param shapeType The type of shape to draw (circle, rectangle, triangle, diamond)
     * @param parent The parent widget
     */
    explicit ShapeIcon(const QString& shapeType = "circle", QWidget* parent = nullptr);
     ...
     * @param type The shape type string (circle, rectangle, triangle, diamond)
     */
